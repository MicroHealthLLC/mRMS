class ReportsController < ApplicationController
  ...
  def show
    ...
    @pivot_tables     = params[:report_enum_id] ? @report.save_pivot_tables.where(report_enum_id: params[:report_enum_id]) : @report.save_pivot_tables.default
    @report_dashboard = params[:dashboard_enum_id] ? @report.dashboards.where(dashboard_enum_id: params[:dashboard_enum_id]) : @report.dashboards.default
